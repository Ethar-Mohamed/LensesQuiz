<!-- <template>
  <div class="w-full h-2 bg-gray-200 rounded-full mt-4">
    <div
      class="h-2 rounded-full bg-teal-900 transition-all duration-500"
      :style="{ width: percentage + '%' }"
    ></div>
  </div>
  <div class="m-2">
    <i class="fa-solid fa-arrow-left animate-bounce m-3 text-teal-900"></i>
    <a href="view.html" class="text-lg font-bold text-teal-900">
      {{ $t("Go Back") }}
    </a>
  </div>
</template>
...
<!-- <template>
  ...
  <div class="m-2 flex items-center cursor-pointer" @click="$router.back()">
    <i class="fa-solid fa-arrow-left animate-bounce text-slate-700 mr-2"></i>
