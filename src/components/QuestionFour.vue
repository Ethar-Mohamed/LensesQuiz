<template>
  ...
  >
    ...
    >
      <div
        v-for="(option, index) in comfortlevelOptions"
        :key="index"
...
export default {
      ...
      comfortlevelOptions: [
        {
          ...
          value: "Never used before",
        },
        { label: "B", text: "🆕 Newbie ", value: "Newbie" },
        { label: "C", text: "💼 Professional", value: "Professional" },
      ],
    };
  },
  // mounted() {
  ...
  methods: {
    selectOption(option) {
      ...
      localStorage.setItem("comfortlevel", this.selected);
